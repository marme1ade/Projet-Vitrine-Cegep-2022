...
import org.vitrine.core.SketchChild;
import processing.core.PApplet;
import processing.core.PVector;

import java.util.ArrayList;

class KochFractal extends SketchChild {
    ...
    KochFractal(PApplet parent) {
        super(parent); // Pass the parent to the super-class (SketchChild)
    ...
    void restart() {
        ...
        lines.add(new KochLine(start,end, parent));  // Add the initial line (from one end PVector to the other)
    }
    ...
    ArrayList iterate(ArrayList<KochLine> before) {
        ...
        for(KochLine l : before) {
            ...
            now.add(new KochLine(a,b, parent));
            now.add(new KochLine(b,c, parent));
            now.add(new KochLine(c,d, parent));
            now.add(new KochLine(d,e, parent));
        }
        return now;
    }
